...
if ($result=mysqli_query($conn,$sql))
  ...
  while ($row=mysqli_fetch_row($result))
    {
    printf ("<h4>%s %s</h4><br /><h5>%s %s %s %s %s %s %s %s %s %s</h5><br />%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s<br />",$row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9],$row[10],$row[11],$row[12],$row[13],$row[
